...
<article tabindex="0" class="resto-item">
  <a href="/#/detail/${restaurant.id}">
    <div class="resto-item_content">
      <img class="resto-item_image lazyload" data-src="${CONFIG.BASE_IMAGE_URL + restaurant.pictureId}" alt="Gambar ${restaurant.name}" tabindex="0"/>
        ...
        <div class="restaurant-detail__menu-list">
          ...
          <h3>Food</h3>
            <ul class="restaurant-detail__foods">
              ...
              <li><i class="fa fa-cutlery font-decoration"></i> ${food.name}</li>`).join('')}
            </ul>
          </div>
          ...
          <h3>Drink</h3>
            <ul class="restaurant-detail__drinks">
              ...
              <li><i class="fa fa-coffee font-decoration"></i> ${drink.name}</li>`).join('')}
            </ul>
          </div>
        </div>
